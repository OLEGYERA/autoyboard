            ...
            <div class="y-visl_items">
                ...
                <div class="y-auto_options">
                    ...
                    <table class="y_check_item-car">
                        <tr>
                            <th class="y-check_icon"><i class="fas fa-check"></i></th>
                            <th class="y-check_title">Марка, модель, год</th>
                            <th class="y-check_desc"> Mercedes-Benz Coupe AMG 53 AT</th>
                        </tr>
                        <tr>
                            <th class="y-check_icon"><i class="fas fa-check"></i></th>
                            <th class="y-check_title">Двигатель</th>
                            <th class="y-check_desc">Бензин</th>
                        </tr>
                        <tr>
                            <th class="y-check_icon"><i class="fas fa-check"></i></th>
                            <th class="y-check_title">Цвет</th>
                            <th class="y-check_desc">Серый</th>
                        </tr>
                        <tr>
                            <th class="y-check_icon"><i class="fas fa-check"></i></th>
                            <th class="y-check_title">В розыске</th>
                            <th class="y-check_desc">Нет </th>
                        </tr>
                        <tr>
                            <th class="y-check_icon"><i class="fas fa-check"></i></th>
                            <th class="y-check_title">Пробег проверен</th>
                            <th class="y-check_desc">19 тыс.км (2 года, 4 мес. назад). Последняя имеющаяся фиксация пробега больше года назад - 02.02.2018</th>
                        </tr>
                        <tr>
                            <th class="y-check_icon"><i class="fas fa-check"></i></th>
                            <th class="y-check_title">Пробег от продавца</th>
                            <th class="y-check_desc">62 тыс.км</th>
                        </tr>
                        <tr>
                            <th class="y-check_icon"><i class="fas fa-check"></i></th>
                            <th class="y-check_title">Последняя операция</th>
