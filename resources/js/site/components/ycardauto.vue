<template>
    <div class="yb_auto-item" v-if="windowWidth > 600">
                ...
                <div class="yb-scroll_vis">
                    <vuescroll :ops="ops">
                        <div class="yb-full_carousel" ref="scrollTo">
                            <figure :class="{active_item: item === imgList[currImgIdx]}"
                                    :key="j"
                                    @click="currImgIdx = j"
                                    class="chunk_item"
                                    v-for="(item,j) in imgList"
                            >
                                <div class="yb_count-img" v-if="item === imgList[currImgIdx]">
            ...
            <div class="yb_auto_vis-l">
                <div class="y-visl_items">
                    ...
                    >
                        ...
                        <div @click="imgFullList = !imgFullList" class="yb_img-fulllist" v-if="imgList.length > 5">
                    ...
                    <div class="y-auto_options">
                        <div class="yb_verified_car">
                            <div class="yb_verified_content" v-if="verifiedCar">
                            ...
                            <div class="yb_disable-verified" v-else>
                        ...
                        <table class="y_check_item-car">
                            ...
                            <tr>
                                ...
                                <th class="y-check_desc" v-if="lang == 'ru' ">Электро</th>
                                <th class="y-check_desc" v-else>Електро</th>
                            </tr>
                            <tr>
                                <th class="y-check_title">
                                    <i class="fas fa-check"></i>
                                ...
                                <th class="y-check_desc" v-if="lang == 'ru' ">Серый</th>
                                <th class="y-check_desc" v-else>Сірий</th>
                            </tr>
                            <tr>
                                <th class="y-check_title">
                                    <i class="fas fa-check"></i>
                                ...
                                <th class="y-check_desc" v-if="lang == 'ru' ">Нет</th>
                                <th class="y-check_desc" e-else>Ні</th>
                            </tr>
                            <tr>
                                <th class="y-check_title">
                                    <i class="fas fa-check"></i>
                                ...
                                <th class="y-check_desc" v-if="lang == 'ru'">19 тыс.км (2 года, 4 мес. назад). Последняя
                                    имеющаяся фиксация пробега больше года назад - 02.02.2018
                                </th>
                                <th class="y-check_desc" v-else>19 тис.км (2 роки, 4 міс. назад). Остання наявна
                            ...
                            <tr>
                                ...
                                <th class="y-check_desc" v-if="lang == 'ru'">62 тыс.км</th>
                                <th class="y-check_desc" v-else>62 тис.км</th>
                            </tr>
                            <tr>
                                <th class="y-check_title">
                                    <i class="fas fa-check"></i>
                                ...
                                <th class="y-check_desc" v-if="lang == 'ru'">27.07.2019 (11 мес. назад)</th>
                                <th class="y-check_desc" v-else>27.07.2019 (11 міс. назад)</th>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <div class="yb_auto_vis-r">
                <div class="yvis_item-car">
                    <div class="vis_car-price">
                        ...
                        <button class="price_monitoring" v-if="lang =='ru' ">
                            Мониториг цен на авто
                        </button>
                        <button class="price_monitoring" v-else>
                    ...
                    <div class="yvis-car_options">
                        <div class="y-car_option">
                            ...
                            <div class="yoption_name">
                                ...
                                <h2 v-else>Пробіг</h2>
                                <span class="y-option" v-if="lang == 'ru'">331 тыс.км </span>
                                <span class="y-option" v-else>331 тис.км </span>
                            </div>
                        ...
                        <div class="y-car_option">
                            ...
                            <div class="yoption_name">
                                ...
                                <span class="y-option" v-if="lang == 'ru'"> Киев </span>
                                <span class="y-option" v-else> Київ </span>
                            </div>
                        </div>
                        <div class="y-car_option">
                            ...
                            <div class="yoption_name">
                                ...
                                <h2 v-else>Двигун</h2>
                                <span class="y-option" v-if="lang == 'ru'">Электро </span>
                                <span class="y-option" v-else>Електро </span>
                            </div>
                        </div>
                        <div class="y-car_option">
                        ...
                        <div class="y-car_option">
                            ...
                            <div class="yoption_name">
                                <h2>Кузов</h2>
                                <span class="y-option" v-if="lang =='ru'">Хэтчбек</span>
                                <span class="y-option" v-else>Хетчбек</span>
                            </div>
                        </div>
                        <div class="y-car_option">
                            ...
                            <div class="yoption_name">
                                <h2>Коробка</h2>
                                <span class="y-option" v-if="lang =='ru'">Ручная / Механика</span>
                                <span class="y-option" v-else>Ручна / Механіка</span>
                            </div>
                        </div>
                    </div>
                    <div class="yb-additional_car-opt">
                        <div class="yadditional_i">
                            <div class="yvis_item">
                                <h2 class="y-item name" v-if="lang == 'ru'">Просмотров авто:</h2>
                                <h2 class="y-item name" v-else>Переглядів авто:</h2>
                                <span class="y-item count">120</span>
                            </div>
                            <div class="yvis_item">
                                <h2 class="y-item name" v-if="lang == 'ru'">Создано:</h2>
                                <h2 class="y-item name" v-else>Створено:</h2>
                                <span class="y-item count" v-if="lang == 'ru'">06 июня</span>
                                <span class="y-item count" v-else>06 червня</span>
                            </div>
                        </div>
                        <div class="yadditional_i">
                            <div class="yvis_item">
                                <h2 class="y-item name" v-if="lang == 'ru'">Добавлено в блокнот:</h2>
                                <h2 class="y-item name" v-else>Додано в блокнот:</h2>
