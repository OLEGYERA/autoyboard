<template>
    <div class="yb-auth">
        ...
        <div class="yb-auth-box yb-tm-box" v-if="!isformSendedSuccess">
            ...
            <form class="yb-auth-form" @submit.prevent="signData">
                ...
                <yinput :type="'text'" :name="'first_name'" :placeholder="'Имя'" :status="form.first_name" :yref="form.first_name.ref" @yturn="fnameYturn"></yinput>
